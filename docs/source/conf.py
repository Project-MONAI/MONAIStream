...
author = "MONAI Stream Contributors"

# The full version, including alpha/beta/rc tags
short_version = monaistream.__version__.split("+")[0]
...
html_theme_options = {
    "icon_links": [
        {
            "name": "GitHub",
            "url": "https://github.com/project-monai/monaistream",
...
def generate_apidocs(*args):
    ...
    module_path = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "..", "src", "monaistream"))
